...
public class GCMRegistrationIntentService extends IntentService {
    ...
    private void registerGCM() {
        ...
        try {
            ...
            token = instanceID.getToken("255912131870", GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
    ...
    /*private void saveTokenToServer(String token){
        ...
        try {
            String msgResult = getStringResultFromService_POST("http://10.0.2.2/gcm/gcm.php", paramPost);
